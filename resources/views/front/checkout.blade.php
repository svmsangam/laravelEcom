                         ...
                         <div class="panel-body">
                          <div class="row">
                           ...
                           <div class="row">
                             ...
                             <div class="col-md-4">
                               <div class="aa-checkout-single-bill">
                                 <input type="text" placeholder="Postcode / ZIP*" value="" name="zip" required>
                               </div>
                             </div> --}}
                           </div>   
                     ...
                     <table class="table table-responsive">
                       ...
                       <tbody>
                         ...
                         <tr>
                           ...
                           <br/>
                           <span class="cart_size">{{$list->size}}</span>
                           </td>
                           <td>NPR {{$list->price*$list->qty}}</td>
                         </tr>
                         @endforeach
                       </tbody>
                       <tfoot>
                         <tr class="hide show_coupon_box">
                           <th>Coupon Code <a href="javascript:void(0)" onclick="removeCouponCode()"><button type="button" 
                          ...
                          <tr>
                           <th>Total</th>
                           <td id="total_price">NPR {{$totalPrice}} </td>
                         </tr>
                       </tfoot>
                     </table>
                   </div>
